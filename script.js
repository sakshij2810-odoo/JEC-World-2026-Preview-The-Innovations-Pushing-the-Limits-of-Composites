/* ============================================
   JEC WORLD 2026 BLOG - JAVASCRIPT
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const animatedElements = document.querySelectorAll(
    ".stat-card, .learn-more-card, .feature-item, .spec-card",
  );
...
(function () {
  var el = document.getElementById("matWinnersChart");
  if (!el) return;
  var observer = new IntersectionObserver(
    function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          el.classList.add("mat-winners-animated");
          observer.disconnect();
        }
      });
    },
...
(function () {
  var el = document.getElementById("venueMapRoot");
  if (!el) return;
  var observer = new IntersectionObserver(
    function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          el.classList.add("venue-map-animated");
          observer.disconnect();
        }
      });
    },
